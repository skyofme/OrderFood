...
public class AlipayController {
	 ...
	 * @version V1.0
	 */
	@RequestMapping(value = "/goAlipay/{totalprice}/{oid}", produces = "text/html; charset=UTF-8")
	@ResponseBody
	public String goAlipay(@PathVariable("totalprice") Integer totalprice ,@PathVariable("oid") Integer oid,HttpServletRequest request, HttpServletRequest response) throws Exception {
 
//		JSONObject jsonObject = new JSONObject();
//		jsonObject.put("out_trade_no", oId);
//		jsonObject.put("total_amount", totalprice);
//		jsonObject.put("subject", "thanks");
		//获得初始化的AlipayClient
